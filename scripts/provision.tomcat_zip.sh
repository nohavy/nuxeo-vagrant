...
# TODO consider using "apt install nuxeo" available on the repo http://apt.nuxeo.org/dists/stretch/releases/binary-amd64/Packages added on /etc/apt/sources.list.d/nuxeo.list
